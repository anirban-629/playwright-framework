...
test.describe("Mark all as completed", { tag: "@markalldone" }, () => {
...
test.describe("Item", () => {
	...
	test("should allow me to edit an item", async ({ page, todoPage }) => {
		await todoPage.createDefaultTodos();
...
test.describe("Editing", () => {
	...
	test("should save edits on blur", async ({ page, todoPage }) => {
		const todoItems = page.locator(".todo-list li");
	...
	test("should trim entered text", async ({ page, todoPage }) => {
		const todoItems = page.locator(".todo-list li");
		await todoItems.nth(1).dblclick();
		await todoItems.nth(1).locator(".edit").fill("    buy some sausages    ");
...
test.describe("Persistence", () => {
	test("should persist its data", async ({ page, todoPage }) => {
		...
		todoPage.checkNumberOfCompletedTodosInLocalStorage(1);
...
test.describe("Routing", () => {
	...
	test("should allow me to display all items", async ({ page, todoPage }) => {
		await page.locator(".todo-list li .toggle").nth(1).check();
		await todoPage.checkNumberOfCompletedTodosInLocalStorage(1);
		await page.locator(".filters >> text=Active").click();
		await page.locator(".filters >> text=Completed").click();
