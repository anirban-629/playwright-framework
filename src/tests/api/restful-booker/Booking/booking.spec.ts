...
import { IRBBooking } from "../../../../../types";
import { RBBooking } from "../../../../utils/restfull-booker/RBBooking";
...
test.describe("Booking", { tag: "@booking" }, async () => {
    ...
    test("TC2 – Auth POST /auth", async ({}) => {
        ...
        expect(validRes.headers()["content-type"]).toContain(
            "application/json",
        );
